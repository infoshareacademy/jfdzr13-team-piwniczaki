      ...
      <div className={styles.menuNav}>
        {isOnMainPage ? (
          <>
            <ScrollTrigger
              to="aboutUs"
              className={styles.linkElemenets}
              smooth="true"
              duration={700}
            >
              O nas
          ...
          <>
            <Link to="/" className={styles.linkElemenets}>
              Strona Główna
            </Link>
          </>
        )}
        {currentUser ? (
          <>
            <Link to="/search" className={styles.linkElemenets}>
              Znajdź Petsittera
            </Link>
            <NavProfile />
          </>
          ...
          <>
            {isOnLog ? (
              <>
                <Link to="/register" className={styles.linkElemenets}>
                  Zarejestruj się
                </Link>
              </>
            ) : (
              <>
                {isOnReg ? (
                  <>
                    <Link to="/login" className={styles.linkElemenets}>
                      Zaloguj się
                    </Link>
                  </>
                ) : (
